...
//     // Don't include password in cache for security reasons
//     const projection = includePassword ? "+password" : undefined;
//     const user = await this.dbService.findOne({ email }, projection);
//     if (!user) return null;
//     return user;
//   }
//
